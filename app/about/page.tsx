        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-5xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed max-w-4xl mx-auto">
              Three generations of passion, tradition, and innovation in
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                Our journey began in 1952 when my grandfather, Hassan, started
                cultivating a small plot of land in the fertile valleys of
                Morocco. With nothing but determination and a deep love for the
                earth, he grew the finest fruits and vegetables the region had
                ever seen.
              </p>
              <p className="text-gray-600 dark:text-gray-300">
                Today, three generations later, we continue his legacy while
                embracing modern sustainable practices. Our 500-hectare farm now
                supplies premium organic produce to customers across 50
                countries, but we've never forgotten our roots or compromised on
                quality.
              </p>
              <p className="text-gray-600 dark:text-gray-300">
                Every fruit and vegetable that leaves our farm carries with it
                the same care, attention, and love that Hassan put into his
                first harvest over 70 years ago.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              These principles guide everything we do, from seed to harvest to
              your table
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow dark:bg-gray-700">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  We use eco-friendly farming practices that protect our soil,
            ...
            <Card className="border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow dark:bg-gray-700">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Every decision we make honors our family's legacy while
                  embracing innovation and modern best practices.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow dark:bg-gray-700">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  ...
                  highest international standards before it reaches our
                  customers.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow dark:bg-gray-700">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  We support our local community by providing fair employment
                  and investing in local infrastructure and education.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow dark:bg-gray-700">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  We believe in responsible global trade that benefits both our
                  customers and our local farming community.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow dark:bg-gray-700">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  We guarantee timely delivery and consistent quality, building
                  long-term partnerships with our customers worldwide.
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                We're committed to farming methods that protect our environment
                while producing the highest quality fruits and vegetables.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      Advanced drip irrigation systems reduce water usage by 40%
                      while ensuring optimal plant hydration.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      100% certified organic practices with no synthetic
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      Solar panels power 80% of our farm operations, reducing
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      Crop rotation and natural composting maintain soil
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="text-center dark:bg-gray-700">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Third-generation farmer leading our sustainable agriculture
            ...
            <Card className="text-center dark:bg-gray-700">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Expert in sustainable farming practices and organic
            ...
            <Card className="text-center dark:bg-gray-700">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Manages international logistics and ensures quality delivery
