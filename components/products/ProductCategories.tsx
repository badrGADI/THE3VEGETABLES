...
function ProductCard({
  ...
  const categoryLabel = category === "vegetable" ? "Vegetable" : "Fruit";
    ...
    <Card className="group hover:shadow-xl transition-all duration-300 overflow-hidden p-0">
      <div className="relative w-full h-48">
        ...
        <div className="absolute top-4 left-4 flex flex-col gap-2 z-10">
          <Badge className="bg-orange-500 text-white">{categoryLabel}</Badge>
          {product.organic && (
      ...
      <CardContent className="p-6">
        ...
        <div className="space-y-2 mb-4">
          ...
          <div className="flex items-center justify-between text-sm">
            <span className="text-gray-500 dark:text-gray-400">Varieties:</span>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 dark:text-gray-300 text-lg max-w-2xl mx-auto">
              Export-ready vegetables from Moroccan farms, packed for
        ...
        <div>
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 dark:text-gray-300 text-lg max-w-2xl mx-auto">
              High-quality Moroccan fruit exports prepared for global shipments.
            </p>
          </div>
